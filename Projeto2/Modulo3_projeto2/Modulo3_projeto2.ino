...
float temperatura; // variávle para temperatura (medida em mV convertida para Celsius)
...
void display_temperatura(int temperatura){
  ...
  number_to_display(temp1); //mascara para mostrar numero

  //segundo dígito
  temp2 = (temperatura / 10U) % 10; ;
  select_display("D3"); //seleciona D3
  number_to_display(temp2); //mascara para mostrar numero

  //terceiro dígito
  temp3 = (temperatura / 100U) % 10; ;
  select_display("D2"); //seleciona D2
  number_to_display(temp3); //mascara para mostrar numero

  //quarto dígito
  temp4 = (temperatura / 1000U) % 10; ;
  select_display("D1"); //seleciona D1
  number_to_display(temp4); //mascara para mostrar numero
}
...
void loop() {
  ...
  temperatura = (sensorValue/1024.0) * 500; // converte valor de mV para Celsius
